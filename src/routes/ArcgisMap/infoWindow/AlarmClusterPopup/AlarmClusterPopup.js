...
export default class AlarmClusterPopup extends PureComponent {
  ...
  render() {
    ...
    return (
      <ClusterPopup count={alarms.count} circleBackground={circleBackground} content={content} style={style} handleClick={this.handleClick} handleMouseOver={this.handleMouseOver} handleMouseOut={this.handleMouseOut} />
    );
  }
}
