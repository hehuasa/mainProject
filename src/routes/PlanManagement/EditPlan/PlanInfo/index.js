...
import { Select, Table, Tabs, Card, Divider, Button, Row, Col, Popconfirm, Checkbox, Icon, Form } from 'antd';
          ...
          <TabPane tab="应急资源" key="6" disabled={Object.keys(planBasicInfo).length === 0 || planBasicInfo.statu === 0}>
            <Card title="应急资源" extra={isEdit ? <Button onClick={this.openAddResourceModel}>新增资源</Button> : null} style={{}}>
              <Table
                ...
                dataSource={planResource}
                rowKey={record => record.readMaterialID}
                scroll={{ x: 1200, y: 270 }}
              />
            </Card>
          </TabPane>
