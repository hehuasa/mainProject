  ...
  return (
    <div style={{ width: 200 }}>
      <div className={styles.weatherBack}>
        <div> {weather.weather.temperature ? weather.weather.temperature.substring(0, weather.weather.temperature.indexOf('.') + 2) : weather.weather.temperature}<i>°C</i></div>
        ...
        <span className={styles.showBack}>
          <span className={this.state.visible ? styles.open : ''} style={{ position: 'relative' }}>
            <span className={styles.weather}>
              ...
              {weather.weather.temperature ? weather.weather.temperature.substring(0, weather.weather.temperature.indexOf('.') + 2) : weather.weather.temperature}{weather.weather.temperature ? '°C' : null}
