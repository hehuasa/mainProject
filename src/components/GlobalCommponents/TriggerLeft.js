  ...
  render() {
    return (
      <div className={styles['trigger-left']}>
        ...
        <Icon className={styles.icon} onClick={this.handleLeftCollapsed} type={this.props.collapsed ? 'right-circle-o' : 'left-circle-o'} style={{ color: this.props.collapsed ? 'grey' : '#1890ff' }} />
      </div>
    );
  }
}
