...
export const autoContentHeight = (domType, changingType) => {
  const header = 80; const points = 0; const evrVideo = 0; const footer = 190;
  const map = 275; const space = 16; const tabs = 35;
  ...
  // }
  // notification.info({
  //   message: 'cruent window.innerHeight',
  //   description: window.innerHeight,
  // });
  // notification.info({
  //   message: 'cruent document.body.clientHeight',
  //   description: document.body.clientHeight,
  // });
  // notification.info({
  //   message: 'cruent document.body.clientHeight',
  //   description: document.body.clientHeight,
  // });
  // notification.info({
  //   message: 'cruent document.documentElement.clientHeight',
  //   description: document.documentElement.clientHeight,
  // });
  switch (domType) {
    case 'page': height = header;
      winHeight -= height;
      break;
    case 'content': height = header + footer + space;
      winHeight -= height;
      break;
    case 'map':
      ...
      break;
    case 'rightSide':
      winHeight = winHeight - header - footer - space - tabs + 8;
      break;
    case 'sideZoom':
      winHeight = winHeight - footer - tabs - header - space - 35;
      break;
    default: break;
  }
  switch (changingType) {
